...
func (c *pdClient) GetGCSafePointV2(ctx context.Context, keyspaceID uint32) (uint64, error) {
	//TODO implement me
	panic("implement me")
}
...
func (c *pdClient) WatchGCSafePointV2(ctx context.Context) (chan []*pdpb.SafePointEvent, error) {
	//TODO implement me
	panic("implement me")
}
